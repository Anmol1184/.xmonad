...
rofi_launcher 		= spawn "~/.xmonad/rofi/launchers/colorful/launcher.sh"
rofi_mpd 			= spawn "~/.xmonad/rofi/applets/android/mpd.sh"
rofi_network 		= spawn "~/.xmonad/rofi/applets/android/network"
rofi_network_menu 	= spawn "~/.xmonad/rofi/applets/android/network_menu"
rofi_powermenu 		= spawn "~/.xmonad/rofi/applets/android/powermenu.sh"
rofi_screenshot 	= spawn "~/.xmonad/rofi/applets/android/screenshot.sh"
